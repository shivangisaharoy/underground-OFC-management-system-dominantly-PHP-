        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="hoppapro.php" method="POST" enctype="multipart/form-data">



<tr>
<td>Enter Block Section ID To Check Fibre Events</td>
<?php
$mysqli=NEW MySQLi('localhost','root','','DBname');
$resultSet=$mysqli->query("select bsid from detail");
?>
...
<tr>
<td>Enter Cable ID To Check Fibre Events</td>
<?php
$mysqli=NEW MySQLi('localhost','root','','DBname');
$resultSet=$mysqli->query("select cid from detail");
?>
...
<input type="text" name="cid" id="txtvalue1" size="48">
</tr>
